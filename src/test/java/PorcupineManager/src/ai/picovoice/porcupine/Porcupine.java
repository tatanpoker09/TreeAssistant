...
/**
 * Android binding for Picovoice's wake word detection (aka ai.picovoice.porcupine.Porcupine) library.
 */
public class Porcupine {
    ...
    static {
        System.loadLibrary("libpv_porcupine");
    }
     ...
     * @throws PorcupineException if there is an error while initializing ai.picovoice.porcupine.Porcupine.
     */
    public Porcupine(
    ...
    /**
     * Audio sample rate accepted by ai.picovoice.porcupine.Porcupine library.
     * @return sample rate acceptable by ai.picovoice.porcupine.Porcupine.
     */
    ...
    /**
     * Releases resources acquired by ai.picovoice.porcupine.Porcupine's library.
     */
    public void delete() {
        delete(object);
    }
