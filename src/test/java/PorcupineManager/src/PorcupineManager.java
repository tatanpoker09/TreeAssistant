...
/**
 * PorcupineManager records the raw audio, processes it in a stream fashion using ai.picovoice.porcupine.Porcupine library,
...
public class PorcupineManager {
    ...
    private class PorcupineAudioConsumer implements AudioConsumer {
         ...
         * the PCM data by ai.picovoice.porcupine.Porcupine library.
         */
        @Override
     ...
     * @throws PorcupineManagerException if there is an error while initializing ai.picovoice.porcupine.Porcupine.
     */
